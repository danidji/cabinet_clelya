        ...
        <>
            ...
            <div className={styles.page_container}>
                ...
                <div className={styles.page_content}>
                    ...
                    <p>
                        Le site web accessible à l&apos;adresse cabinet-clelya-voyance.com (ci-après le &ldquo;Site&ldquo;) est édité par Clelya
                        Peter, dont l&apos;activité est la pratique de la voyance.
                    </p>
                    ...
                    <p>
                        Le Site, ainsi que tous les éléments qui le composent (notamment les textes, images, photographies, logos, marques, etc.) sont
                        la propriété exclusive de Clelya Peter et/ou de ses partenaires et sont protégés par les lois françaises et internationales
                        relatives à la propriété intellectuelle. Toute reproduction, représentation, modification, publication, transmission,
                        dénaturation, totale ou partielle du Site ou de son contenu, par quelque procédé que ce soit, et sur quelque support que ce
                        soit, est interdite, sauf autorisation expresse et préalable de Clelya Peter.
                    </p>
                    ...
                    <p>
                        Clelya Peter s&apos;efforce de maintenir le Site accessible et à jour. Toutefois, Clelya Peter ne garantit pas
                        l&apos;exactitude, la complétude ou l&apos;adéquation des informations contenues sur le Site. Clelya Peter ne pourra être
                        tenue responsable de tout dommage direct ou indirect résultant de l&apos;utilisation ou de l&apos;impossibilité
                        d&apos;utiliser le Site.
                    </p>
                    <h2>IX. Droit applicable et juridiction compétente</h2>
                    <p>
                        Les présentes mentions légales sont soumises au droit français. Tout litige relatif à l&apos;interprétation ou à
                        l&apos;exécution des présentes mentions légales sera soumis à la compétence exclusive des tribunaux français.
                    </p>
                    <h2>X. Contact</h2>
                    <p>
